...
> 原文：[DLology Blog](https://www.dlology.com/)
> 
...
* [在线阅读](https://dlology.apachecn.org)
...
*   在我们的 [apachecn/dlology-blog-zh](https://github.com/apachecn/dlology-blog-zh) github 上提 issue.
...
```
docker pull apachecn0/dlology-blog-zh
docker run -tid -p <port>:80 apachecn0/dlology-blog-zh
...
```
pip install dlology-blog-zh
dlology-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
